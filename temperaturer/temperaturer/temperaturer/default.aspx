...
<body>
    ...
    <form id="form1" runat="server" defaultbutton="SubmitButton" >
        ...
        <div>
            ...
            <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="CompareValidator" Operator="LessThanEqual" ControlToCompare="MinTextBox" ControlToValidate="MaxTextBox"></asp:CompareValidator>
        </div>
        ...
        <div>
            ...
            <div>
                <asp:RadioButton ID="Celsius" runat="server" GroupName="Scale" Text="Celsius" />

            </div>
            <div>
                <asp:RadioButton ID="Fahrenheit" runat="server" GroupName="Scale" Text="Fahrenheit" />
